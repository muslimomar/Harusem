...
import com.example.william.harusem.ui.adapters.OpponentsFromCallAdapter;
...
//          for correct removing item in adapter
    ...
    private void updateSwitchCameraIcon(final MenuItem item) {
        if (isCurrentCameraFront) {
            ...
            item.setIcon(R.drawable.ic_action_camera_front);
        } else {
            Log.d(TAG, "CameraRear now!");
            item.setIcon(R.drawable.ic_action_camera_rear);
        }
    }
