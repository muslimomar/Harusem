...
import com.example.william.harusem.utils.ResourceUtils;
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        if (user != null) {
            ...
            if (selectedItems.contains(user)){
                ...
                holder.opponentIcon.setImageResource(R.drawable.check);
            } else {
                ...
                holder.opponentIcon.setImageResource(R.drawable.ic_person_big);
            }
        }
