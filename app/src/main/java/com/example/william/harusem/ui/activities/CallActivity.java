...
import com.example.william.harusem.fragments.AudioConversationFragment;
import com.example.william.harusem.fragments.BaseConversationFragment;
import com.example.william.harusem.fragments.ConversationFragmentCallbackListener;
import com.example.william.harusem.fragments.IncomeCallFragment;
import com.example.william.harusem.fragments.IncomeCallFragmentCallbackListener;
import com.example.william.harusem.fragments.OnCallEventsController;
import com.example.william.harusem.fragments.ScreenShareFragment;
import com.example.william.harusem.fragments.VideoConversationFragment;
import com.example.william.harusem.holder.QBUsersHolder;
import com.example.william.harusem.util.NetworkConnectionChecker;
import com.example.william.harusem.util.Toaster;
import com.example.william.harusem.util.consts.Consts;
import com.example.william.harusem.utils.FragmentExecuotr;
import com.example.william.harusem.utils.PermissionsChecker;
import com.example.william.harusem.utils.QBEntityCallbackImpl;
...
//            we have already currentSession == null, so it's no reason to do further initialization
    ...
    private void startLoadAbsentUsers() {
        ArrayList<QBUser> usersFromDb = qbUsersHolder.getAllUsers();
    ...
    private void initFields() {
        //////////////////////////////////////////////It had getApplicationContext() inside getInstance();
    ...
    public void onReceiveHangUpFromUser(final QBRTCSession session, final Integer userID, Map<String, String> map) {
        if (session.equals(getCurrentSession())) {
            ...
            QBUser participant = qbUsersHolder.getUserById(userID);
