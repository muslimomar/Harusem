...
public abstract class BaseConversationFragment extends BaseToolBarFragment implements CallActivity.CurrentCallStateCallback {
    ...
    protected QBUsersHolder qbUsersHolder;
    ...
    protected void initFields() {
        ...
        ///something was supposed to be inside the getInstance down;
    ...
    private void initOpponentsList() {
        ...
        List<QBUser> usersFromDb = qbUsersHolder.getUsersByIds(currentSession.getOpponents());
        //Down here it was 'userFromDb' I changed it to 'ArrayList<QBUser>) usersFromDb'
        opponents = UsersUtils.getListAllUsersFromIds((ArrayList<QBUser>) usersFromDb, currentSession.getOpponents());

        QBUser caller = qbUsersHolder.getUserById(currentSession.getCallerID());
        if (caller == null) {
