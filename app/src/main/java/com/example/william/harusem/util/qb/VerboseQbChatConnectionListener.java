package com.example.william.harusem.util.qb;
...
public class VerboseQbChatConnectionListener implements ConnectionListener {
    ...
    public void connectionClosedOnError(final Exception e) {
        ...
        snackbar = Snackbar.make(rootView, Harusem.getInstance().getString(R.string.connection_error), Snackbar.LENGTH_INDEFINITE);
        snackbar.show();
    }
