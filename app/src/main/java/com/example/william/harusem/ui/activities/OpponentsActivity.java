...
import com.example.william.harusem.ui.adapters.OpponentsAdapter;
       ...
       // String currentUserName=qbUsersHolder.getUserById()
        ...
        requestExecutor.loadUsersByTag(currentUserName, new QBEntityCallback<ArrayList<QBUser>>() {
            ...
            public void onSuccess(ArrayList<QBUser> result, Bundle params) {
                hideProgressDialog();
                //I have deleted the seconed parameter wich is true(boolean)
...
//      checking whether currentOpponentsList is actual, if yes - return
        if (currentOpponentsList != null) {
            ArrayList<QBUser> actualCurrentOpponentsList = qbUsersHolder.getAllUsers();
    ...
    private void proceedInitUsersList() {
        currentOpponentsList = qbUsersHolder.getAllUsers();
